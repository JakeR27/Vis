...
namespace Vis
{
    public static class Constants
    {
        ...
        public static string AUTH_REQUEST_KEY(int orgId, int unitId) => $"{orgId}.{unitId}.responses.auth";
        public static string HOST_RESPONSE_KEY(int orgId, int unitId) => $"{orgId}.{unitId}.requests.host";
